          ...
          <div className="flex flex-col justify-between gap-8 md:flex-row md:items-end">
            <div>
              ...
              <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-300">
                Дундад зууны Монгол болон дэлхийн түүхийг бүлэг, сэдвээр
                дарааллаар нь судлах интерактив хичээлийн хэсэг.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-3">
              <Stat value="35" label="Хичээл" />
              <Stat value="5" label="Бүлэг" />
            </div>
          </div>
        </div>
      </section>
