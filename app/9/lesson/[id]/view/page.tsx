...
export default function LessonView() {
  ...
  function submitTest() {
    ...
    const saved = localStorage.getItem("history9-progress");

    const progress = saved ? JSON.parse(saved) : {};

    progress[lesson.id] = result;
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-6xl px-6 py-12">
        {/* LESSON HEADER */}
        <div className="rounded-3xl border border-cyan-400/20 bg-gradient-to-br from-cyan-950/40 via-white/5 to-violet-950/30 p-8 sm:p-12">
            ...
            {submitted && (
              ...
              >
                ...
                <p className="mt-5 text-lg text-slate-300">
                  {percentage === 100
                    ? "🎉 Гайхалтай! Бүх асуултад зөв хариуллаа."
                    : percentage >= 80
                    ? "👏 Маш сайн! Хичээлийн агуулгыг сайн ойлгожээ."
                    : percentage >= 60
        ...
        <section className="mt-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            {previousLesson ? (
              <Link
                href={`/9/lesson/${previousLesson.id}/view`}
            ...
            {nextLesson ? (
              <Link
                href={`/9/lesson/${nextLesson.id}/view`}
