  ...
  for (const book of libraryBooks) {
    for (const chunk of book.chunks) {
      ...
      docs.push({
        ...
        weak: chunk.body,
        /*
         * Анхдагч эх сурвалж ба эрдэм шинжилгээний бүтээл нь илүү
         * гүнзгий, эх сурвалжид тулгуурласан тул арай өндөр жинтэй.
         * Сурах бичиг нь хичээлийн агуулгатай давхцдаг — давхардвал
         * хичээл нь дээшилсэн нь сурагчид илүү тустай.
         */
        boost:
          book.kind === "textbook"
            ? 0.95
